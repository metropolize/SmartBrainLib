...
import com.metropolize.mtzcharacterengine.api.core.behaviour.custom.path.SetWalkTargetToAttackTarget;
 ...
 * This is mostly superceded by {@link SetWalkTargetToAttackTarget SetWalkTargetToAttackTarget}, but can be useful if you want the brain owner to look at the target without pathing to it
 * @param <E> The entity
 */
